...
public class CancellaDialogMonumentoViaggio {
    ...
    String citta, email, nome, categoria;

    CancellaDialogMonumentoViaggio (Activity activity, Context context, String citta, String email, String nome, String categoria) {
