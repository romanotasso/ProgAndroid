...
public class CancellaDialogHotel {
    ...
    String punto;
    String citta;
    String URL_CANCELLA = "http://progandroid.altervista.org/progandorid/deletePhotoHotelBB.php";

    CancellaDialogHotel(Activity myActivity, Context context, String punto,String citta) {
        activity = myActivity;
    ...
    void startLoadingDialog () {
        ...
        builder.setPositiveButton(R.string.si, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                deleteImageHotel deleteImageHotel = new deleteImageHotel();
                deleteImageHotel.execute();
            }
        });
    ...
    private class deleteImageHotel extends AsyncTask<Void, Void, Void> {
        ...
        String hotelsenzaspazio = punto.replaceAll(" ","%20");
        String path = cittaSenzaSpazio+hotelsenzaspazio+"JPG";
